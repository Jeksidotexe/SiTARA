    ...
    <body
        ...
        <!-- Form Modal Update Status Wilayah -->
        @auth
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    function updateDashboardCounts(notification) {
                        if (document.body.classList.contains('dashboard-pimpinan') && notification.type.includes(
                            ...
                            const sidebarCountEl = document.getElementById('sidebar-pending-count');

                            if (sidebarBadge && sidebarCountEl) {
                                let currentSidebarCount = parseInt(sidebarCountEl.innerText) || 0;
                                sidebarCountEl.innerText = currentSidebarCount + 1;
                            ...
                            if (typeof table !== 'undefined' && $.fn.DataTable.isDataTable('#table-laporan-pending')) {
                                table.ajax.reload(null, false);
                                console.log('[Reverb] Reloading DataTables...');
                            }
                        }
