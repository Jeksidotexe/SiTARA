                    ...
                    <div class="card mb-5">
                        <div class="card-body p-3">
                            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                                <div>
                                    <h5 class="font-weight-bolder mb-0">Detail Laporan Harian Pelanggaran Kampanye</h5>
                                </div>
                                @php
                                    $from = request('from');
                                    $userRole = Auth::user()->role;
                                    $backUrl = route('laporan_pelanggaran_kampanye.index');
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <form id="revision-form"
                                        action="{{ route('verifikasi.requestRevision', ['reportType' => 'laporan-pelanggaran-kampanye', 'id' => $laporan->id_laporan]) }}"
                                        method="POST">
                                        @csrf
...
@push('scripts')
    ...
    <script>
        ...
        function loadPdf() {
            ...
            const baseUrl = "{{ route('laporan_pelanggaran_kampanye.previewPdf', $laporan->id_laporan) }}";
