...
@section('page', 'Laporan Harian Pelanggaran Kampanye')

@section('title', 'Laporan Harian Pelanggaran Kampanye')

@section('content')
    <div class="row">
        <div class="ms-3">
            <h3 class="mb-0 h4 font-weight-bolder">Laporan Harian Pelanggaran Kampanye</h3>
            <p class="mb-4">
                Kelola semua Data Laporan Harian Pelanggaran Kampanye.
            </p>
        </div>
    </div>
    <div class="row mb-4">
        <div class="col-12 mb-md-0 mb-4">
            <div class="card">
                <div class="card-header pb-0">
                    <a href="{{ route('laporan_pelanggaran_kampanye.create') }}" class="btn btn-dark glow-dark btn-sm">
    ...
    <script>
        ...
        $(function() {
            ...
            table = $('#table-laporan').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{{ route('laporan_pelanggaran_kampanye.data') }}', // Mengambil data dari route 'laporan_pelanggaran_kampanye.data'
                columns: [{
                        data: 'DT_RowIndex',
                        searchable: false,
                        sortable: false
