...
@section('page', 'Edit Laporan Harian Kejadian Menonjol')
@section('title', 'Edit Laporan Harian Kejadian Menonjol')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Edit Laporan Harian Kejadian Menonjol</h5>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('laporan_kejadian_menonjol.update', $laporan->id_laporan) }}" method="POST"
