...
@section('page', 'Detail Laporan Harian Kejadian Menonjol')
@section('title', 'Detail Laporan Harian Kejadian Menonjol')
                ...
                <div id="laporan-content-wrapper">
                    <div class="card mb-5">
                        <div class="card-body p-3">
                            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                                <div>
                                    <h5 class="font-weight-bolder mb-0">Detail Laporan Harian Kejadian Menonjol</h5>
                                </div>
                                @php
                                    $from = request('from');
                                    $userRole = Auth::user()->role;
                                    $backUrl = route('laporan_kejadian_menonjol.index');
                    ...
                    @if (Auth::user()->role == 'pimpinan' && $laporan->isPending())
                        <form id="approve-form"
                            action="{{ route('verifikasi.approve', ['reportType' => 'laporan-kejadian-menonjol', 'id' => $laporan->id_laporan]) }}"
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <form id="revision-form"
                                        action="{{ route('verifikasi.requestRevision', ['reportType' => 'laporan-kejadian-menonjol', 'id' => $laporan->id_laporan]) }}"
                                        method="POST">
                                        @csrf
                            ...
                            <div class="card">
                                <div class="card-header pb-0">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        @if (Auth::user()->role == 'operator' && $laporan->needsRevision())
                                            <a href="{{ route('laporan_kejadian_menonjol.edit', ['laporan_kejadian_menonjol' => $laporan->id_laporan]) }}"
...
@push('scripts')
    ...
    <script>
        ...
        function loadPdf() {
            ...
            const baseUrl = "{{ route('laporan_kejadian_menonjol.previewPdf', $laporan->id_laporan) }}";
