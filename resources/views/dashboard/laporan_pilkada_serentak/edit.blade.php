...
@section('page', 'Edit Laporan Harian Pilkada Serentak')
@section('title', 'Edit Laporan Harian Pilkada Serentak')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Edit Laporan Harian Pilkada Serentak</h5>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('laporan_pilkada_serentak.update', $laporan->id_laporan) }}" method="POST"
