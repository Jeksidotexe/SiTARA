...
@section('page', 'Laporan Harian Pilkada Serentak')

@section('title', 'Laporan Harian Pilkada Serentak')

@section('content')
    <div class="row">
        <div class="ms-3">
            <h3 class="mb-0 h4 font-weight-bolder">Laporan Harian Pilkada Serentak</h3>
            <p class="mb-4">
                Kelola semua Data Laporan Harian Pilkada Serentak.
            </p>
        </div>
    </div>
    <div class="row mb-4">
        <div class="col-12 mb-md-0 mb-4">
            <div class="card">
                <div class="card-header pb-0">
                    <a href="{{ route('laporan_pilkada_serentak.create') }}" class="btn btn-dark glow-dark btn-sm">
    ...
    <script>
        ...
        $(function() {
            ...
            table = $('#table-laporan').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{{ route('laporan_pilkada_serentak.data') }}', // Mengambil data dari route 'laporan_pilkada_serentak.data'
                columns: [{
                        data: 'DT_RowIndex',
                        searchable: false,
                        sortable: false
