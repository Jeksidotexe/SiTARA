...
@section('page', 'Tambah Laporan Lain-Lain')
@section('title', 'Tambah Laporan Lain-Lain')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Tambah Laporan Lain-Lain</h5>
                        <a href="{{ route('laporan_lain.index') }}"
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('laporan_lain.store') }}" method="POST" id="laporan-form"
