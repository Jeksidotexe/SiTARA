...
@section('page', 'Edit Laporan Lain-Lain')
@section('title', 'Edit Laporan Lain-Lain')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Edit Laporan Lain-Lain</h5>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('laporan_lain.update', $laporan->id_laporan) }}" method="POST"
