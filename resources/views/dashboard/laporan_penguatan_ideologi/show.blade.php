...
{{--
    PERHATIAN: Judul halaman di @section('page') dan @section('title') Anda
    tampaknya salah (tertulis "Pelanggaran Kampanye").
    Saya akan menggantinya agar sesuai dengan nama file "penguatan_ideologi".
--}}
@section('page', 'Detail Laporan Penguatan Ideologi')
@section('title', 'Detail Laporan Penguatan Ideologi')
