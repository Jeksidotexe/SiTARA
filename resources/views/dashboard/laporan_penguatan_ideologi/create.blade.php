...
@section('page', 'Tambah Laporan Penguatan Ideologi Pancasila dan Karakter')
@section('title', 'Tambah Laporan Penguatan Ideologi Pancasila dan Karakter')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items: center">
                        <h5 class="mb-0">Tambah Laporan Penguatan Ideologi Pancasila dan Karakter</h5>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('laporan_penguatan_ideologi.store') }}" method="POST" id="laporan-form"
...
@endif
                                ...
                                @if ($step['file'])
                                    <div class="mb-3">
                                        ...
                                        <small class="text-muted mt-2 d-block">*Hanya menerima file gambar (JPG, JPEG, PNG). Maks. 2MB per
                                            file.</small>
                                    </div>
                                @endif
                            </div>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <button type="button" class="btn btn-sm btn-light bg-gradient-light" id="prev-btn" style="display: none;">
