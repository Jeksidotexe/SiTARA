...
@section('page', 'Laporan Penguatan Ideologi Pancasila dan Karakter')

@section('title', 'Laporan Penguatan Ideologi Pancasila dan Karakter')

@section('content')
    <div class="row">
        <div class="ms-3">
            <h3 class="mb-0 h4 font-weight-bolder">Laporan Penguatan Ideologi Pancasila dan Karakter</h3>
            <p class="mb-4">
                Kelola semua Data Laporan Penguatan Ideologi Pancasila dan Karakter.
            </p>
        </div>
    </div>
    <div class="row mb-4">
        <div class="col-12 mb-md-0 mb-4">
            <div class="card">
                <div class="card-header pb-0">
                    <a href="{{ route('laporan_penguatan_ideologi.create') }}" class="btn btn-dark glow-dark btn-sm">
    ...
    <script>
        ...
        $(function() {
            ...
            table = $('#table-laporan').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{{ route('laporan_penguatan_ideologi.data') }}', // Mengambil data dari route 'laporan_penguatan_ideologi.data'
                columns: [{
                        data: 'DT_RowIndex',
                        searchable: false,
                        sortable: false
