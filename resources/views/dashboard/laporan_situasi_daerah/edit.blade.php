...
@section('page', 'Edit Laporan Situasi Daerah')
@section('title', 'Edit Laporan Situasi Daerah')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Edit Laporan Situasi Daerah</h5>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('laporan_situasi_daerah.update', $laporan->id_laporan) }}" method="POST"
