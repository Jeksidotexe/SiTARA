...
@section('page', 'Detail Laporan Situasi Daerah')
@section('title', 'Detail Laporan Situasi Daerah')
                    ...
                    <div class="card mb-5">
                        <div class="card-body p-3">
                            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                                <div>
                                    <h5 class="font-weight-bolder mb-0">Detail Laporan Situasi Daerah</h5>
                                </div>
                                @php
                                    $from = request('from');
                                    ...
                                    <div class="card h-100">
                                        <div class="card-body p-3"
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-2">
                                                ...
                                                <a href="{{ route('laporan_situasi_daerah.edit', ['laporan_situasi_daerah' => $laporan->id_laporan]) }}"
                                                    ...
                                                    @foreach ($files as $filePath)
                                                        ...
                                                        <div class="file-item-material">
                                                            <div class="file-thumbnail-material">
                                                                ...
                                                                @else
                                                                    {{-- PERUBAHAN: Menghapus logika 'isPdf' --}}
                                                                    <i class="fas fa-file-alt"></i>
                                                                @endif
                                                            </div>
...
@push('scripts')
    ...
    <script>
        ...
        // 2. Panggil fungsi itu saat halaman pertama kali dimuat
                            ...
                            if (e.newStatus === 'deleted') {
                                ...
                                Swal.fire({
                                    ...
                                    window.location.href =
                                        "{{ route('laporan_situasi_daerah.index') }}";
                                });
                                return;
                            }
                            ...
                            fetch(window.location.href) // 'window.location.href' adalah URL saat ini
                                ...
                                .then(html => {
                                    ...
                                    if (newContent && oldContent) {
                                        ...
                                        // Jika modal Anda berhenti bekerja setelah swap,
                                        // Anda perlu memanggil ulang `new bootstrap.Modal(...)` di sini.
                                        // Tapi karena modal ada di luar wrapper, seharusnya aman.
