                                ...
                                <tr>
                                    <td style="padding: 30px 30px 20px 30px; font-family: 'Inter', sans-serif;">
                                        ...
                                        <p
                                            ...
                                            Halo, <strong>{{ $nama_operator }}</strong>,
                                        </p>

                                        <p
                                            style="margin: 0 0 25px 0; font-size: 16px; line-height: 1.6; color: #737373;">
                                            @if ($status == 'disetujui')
                                                Laporan Anda dengan judul <strong>"{{ $judul_laporan }}"</strong> telah
                                                diverifikasi dan disetujui oleh
                                                <strong>{{ $nama_pimpinan_verifikator }}</strong>.
                                            @else
                                                Laporan Anda dengan judul <strong>"{{ $judul_laporan }}"</strong>
                                                statusnya telah diperbarui menjadi <strong
                                                    style="text-transform: uppercase;">{{ $status }}</strong>.
                                            @endif
                                        </p>

                                        @if ($status == 'revisi' && !empty($catatan))
                                            <p
                                                style="margin: 0 0 5px 0; font-size: 14px; font-weight: 600; color: #262626;">
                                                Catatan Pimpinan:
                                            </p>
                                            <p
                                                style="margin: 0 0 25px 0; font-size: 14px; line-height: 1.6; color: #737373; font-style: italic;">
                                                "{{ $catatan }}"
                                            </p>
                                        @endif
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td align="center" style="padding: 10px 0 25px 0;">
                                                    <a href="{{ $url_laporan }}" target="_blank"
                    ...
                    <tr>
                        <td align="center" style="padding: 30px 20px;">
                            <p
                                ...
                                &copy; {{ date('Y') }} Badan Kesatuan Bangsa dan Politik Provinsi Kalimantan Barat.
                                All rights
                                reserved.
                            </p>
