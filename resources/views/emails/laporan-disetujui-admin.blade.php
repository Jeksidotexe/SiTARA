...
<head>
    ...
    <title>Laporan Terverifikasi</title>
                                ...
                                <tr>
                                    <td style="padding: 30px 30px 20px 30px; font-family: 'Inter', sans-serif;">
                                        ...
                                        <p
                                            ...
                                            Halo, <strong>{{ $nama_admin }}</strong>,
                                        </p>
                                        <p
                                            style="margin: 0 0 25px 0; font-size: 16px; line-height: 1.6; color: #737373;">
                                            Laporan berjudul <strong>"{{ $judul_laporan }}"</strong> dari wilayah
                                            <strong>{{ $nama_wilayah }}</strong> telah selesai diverifikasi dan
                                            <strong>DISETUJUI</strong> oleh
                                            <strong>{{ $nama_pimpinan }}</strong>.
                                        </p>
