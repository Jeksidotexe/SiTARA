                                ...
                                <tr>
                                    <td style="padding: 30px 30px 20px 30px; font-family: 'Inter', sans-serif;">
                                        ...
                                        <p
                                            ...
                                            Halo, <strong>{{ $nama_pimpinan }}</strong>,
                                        </p>
                                        <p
                                            style="margin: 0 0 25px 0; font-size: 16px; line-height: 1.6; color: #737373;">
                                            Terdapat laporan baru berjudul <strong>"{{ $judul_laporan }}"</strong> dari
                                            operator <strong>{{ $nama_operator }}</strong> pada tanggal
                                            <strong>{{ $tanggal }}</strong> yang menunggu verifikasi Anda.
                                        </p>
