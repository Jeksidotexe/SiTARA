...
class LaporanPelanggaranKampanyeController extends Controller
{
    ...
    private $storageDiskPath = 'laporan_pelanggaran_kampanye/file'; // Path relatif di dalam disk
    private $publicAccessPath = 'storage/laporan_pelanggaran_kampanye/file'; // Path untuk disimpan di DB
    ...
    {
        // Simpan ke 'public' disk di folder 'laporan_pelanggaran_kampanye/file'
        // store() otomatis menghasilkan hashName
        $path = $file->store($this->storageDiskPath, $this->diskName);

        // $path akan berisi 'laporan_pelanggaran_kampanye/file/hash.ext'
    ...
    private function deleteFile(?string $filePath): void
    {
        ...
        // $filePath dari DB adalah 'storage/laporan_pelanggaran_kampanye/file/hash.ext'
        // Kita perlu 'laporan_pelanggaran_kampanye/file/hash.ext' untuk dihapus
    ...
    {
        $laporan = LaporanPelanggaranKampanye::with(['operator.wilayah'])->findOrFail($id);
        ...
        $filters = [
            'tipe_laporan' => 'Harian Pelanggaran Kampanye',
        ...
        $pdf = Pdf::loadView('dashboard.laporan_pelanggaran_kampanye.preview_pdf', compact(
            'laporan',
            'reports',
            'wilayah',
            'filters',
        ...
        $fileName = 'Laporan_Harian_Pelanggaran_Kampanye_' . Carbon::parse($laporan->tanggal_laporan)->format('d_m_Y') . '.pdf';
    ...
    {
        return view('dashboard.laporan_pelanggaran_kampanye.index');
    }
    ...
    public function data()
    {
        ...
        return datatables()
            ...
            ->addColumn('aksi', function ($laporan) {
                ...
                $editUrl = route('laporan_pelanggaran_kampanye.edit', ['laporan_pelanggaran_kampanye' => $laporan->id_laporan]);
                $showUrl = route('laporan_pelanggaran_kampanye.show', ['laporan_pelanggaran_kampanye' => $laporan->id_laporan]);
                $deleteUrl = route('laporan_pelanggaran_kampanye.destroy', ['laporan_pelanggaran_kampanye' => $laporan->id_laporan]);
    ...
    {
        return view('dashboard.laporan_pelanggaran_kampanye.create');
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            $validatedData['judul'] = 'Laporan Harian Pelanggaran Kampanye';
            ...
            $laporanBaru = LaporanPelanggaranKampanye::create($validatedData);
            ...
            try {
                ...
                if ($pimpinanUsers->isNotEmpty()) {
                    ...
                    $url = route('laporan_pelanggaran_kampanye.show', ['laporan_pelanggaran_kampanye' => $laporanBaru->id_laporan, 'from' => 'notification']);
            ...
            return redirect()->route('laporan_pelanggaran_kampanye.index')
     ...
     */
    public function show(LaporanPelanggaranKampanye $laporan_pelanggaran_kampanye)
    {
        $laporan = $laporan_pelanggaran_kampanye;
        $laporan->loadMissing('operator');

        return view('dashboard.laporan_pelanggaran_kampanye.show', compact(
            'laporan',
        ));
    }
     ...
     */
    public function edit(LaporanPelanggaranKampanye $laporan_pelanggaran_kampanye)
    {
        $laporan = $laporan_pelanggaran_kampanye;
        return view('dashboard.laporan_pelanggaran_kampanye.edit', compact('laporan'));
    }
     ...
     */
    public function update(Request $request, LaporanPelanggaranKampanye $laporan_pelanggaran_kampanye): RedirectResponse
    {
        $laporan = $laporan_pelanggaran_kampanye;
        ...
        try {
            ...
            if ($originalStatus === LaporanPelanggaranKampanye::STATUS_REVISION) {
                $updateData['status_laporan'] = LaporanPelanggaranKampanye::STATUS_PENDING;
                ...
                try {
                    ...
                    if ($pimpinanUsers->isNotEmpty()) {
                        ...
                        $url = route('laporan_pelanggaran_kampanye.show', ['laporan_pelanggaran_kampanye' => $laporan->id_laporan, 'from' => 'notification']);
     ...
     * yang baru.
     */
    public function destroy(LaporanPelanggaranKampanye $laporan_pelanggaran_kampanye)
    {
        try {
            $laporan = $laporan_pelanggaran_kampanye; // Tidak perlu FindOrFail
            ...
            Log::error('Error deleting laporan ' . $laporan_pelanggaran_kampanye->id_laporan . ': ' . $e->getMessage());
