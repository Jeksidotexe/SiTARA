...
class LaporanPenguatanIdeologiController extends Controller
{
    ...
    private $storageDiskPath = 'laporan_penguatan_ideologi/file'; // Path relatif di dalam disk
    private $publicAccessPath = 'storage/laporan_penguatan_ideologi/file'; // Path untuk disimpan di DB
    ...
    {
        // Simpan ke 'public' disk di folder 'laporan_penguatan_ideologi/file'
        // store() otomatis menghasilkan hashName
        $path = $file->store($this->storageDiskPath, $this->diskName);

        // $path akan berisi 'laporan_penguatan_ideologi/file/hash.ext'
    ...
    private function deleteFile(?string $filePath): void
    {
        ...
        // $filePath dari DB adalah 'storage/laporan_penguatan_ideologi/file/hash.ext'
        // Kita perlu 'laporan_penguatan_ideologi/file/hash.ext' untuk dihapus
    ...
    {
        $laporan = LaporanPenguatanIdeologi::with(['operator.wilayah'])->findOrFail($id);
        ...
        $filters = [
            'tipe_laporan' => 'Penguatan Ideologi Pancasila dan Karakter',
        ...
        $pdf = Pdf::loadView('dashboard.laporan_penguatan_ideologi.preview_pdf', compact(
            'laporan',
            'reports',
            'wilayah',
            'filters',
    ...
    {
        return view('dashboard.laporan_penguatan_ideologi.index');
    }
    ...
    public function data()
    {
        ...
        $query = LaporanPenguatanIdeologi::with('operator')
            ->latest('id_laporan');
    ...
    {
        return view('dashboard.laporan_penguatan_ideologi.create');
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            $validatedData['judul'] = 'Laporan Penguatan Ideologi Pancasila dan Karakter';
            ...
            $laporanBaru = LaporanPenguatanIdeologi::create($validatedData);
            ...
            try {
                ...
                if ($pimpinanUsers->isNotEmpty()) {
                    ...
                    $url = route('laporan_penguatan_ideologi.show', ['laporan_penguatan_ideologi' => $laporanBaru->id_laporan, 'from' => 'notification']);
            ...
            return redirect()->route('laporan_penguatan_ideologi.index')
     ...
     */
    public function show(LaporanPenguatanIdeologi $laporan_penguatan_ideologi)
    {
        $laporan = $laporan_penguatan_ideologi;
        $laporan->loadMissing('operator');

        return view('dashboard.laporan_penguatan_ideologi.show', compact(
            'laporan',
        ));
    }
     ...
     */
    public function edit(LaporanPenguatanIdeologi $laporan_penguatan_ideologi)
    {
        $laporan = $laporan_penguatan_ideologi;
        return view('dashboard.laporan_penguatan_ideologi.edit', compact('laporan'));
    }
     ...
     */
    public function update(Request $request, LaporanPenguatanIdeologi $laporan_penguatan_ideologi): RedirectResponse
    {
        $laporan = $laporan_penguatan_ideologi;
        ...
        try {
            ...
            if ($originalStatus === LaporanPenguatanIdeologi::STATUS_REVISION) {
                $updateData['status_laporan'] = LaporanPenguatanIdeologi::STATUS_PENDING;
                ...
                try {
                    ...
                    if ($pimpinanUsers->isNotEmpty()) {
                        ...
                        $url = route('laporan_penguatan_ideologi.show', ['laporan_penguatan_ideologi' => $laporan->id_laporan, 'from' => 'notification']);
     ...
     * yang baru.
     */
    public function destroy(LaporanPenguatanIdeologi $laporan_penguatan_ideologi)
    {
        try {
            $laporan = $laporan_penguatan_ideologi; // Tidak perlu FindOrFail
            ...
            Log::error('Error deleting laporan ' . $laporan_penguatan_ideologi->id_laporan . ': ' . $e->getMessage());
