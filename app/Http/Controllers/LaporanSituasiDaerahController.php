...
class LaporanSituasiDaerahController extends Controller
{
    ...
    private $storageDiskPath = 'laporan_situasi_daerah/file'; // Path relatif di dalam disk
    private $publicAccessPath = 'storage/laporan_situasi_daerah/file'; // Path untuk disimpan di DB
    ...
    {
        // Simpan ke 'public' disk di folder 'laporan_situasi_daerah/file'
        // store() otomatis menghasilkan hashName
        $path = $file->store($this->storageDiskPath, $this->diskName);

        // $path akan berisi 'laporan_situasi_daerah/file/hash.ext'
    ...
    private function deleteFile(?string $filePath): void
    {
        ...
        // $filePath dari DB adalah 'storage/laporan_situasi_daerah/file/hash.ext'
        // Kita perlu 'laporan_situasi_daerah/file/hash.ext' untuk dihapus
    ...
    {
        return view('dashboard.laporan_situasi_daerah.index');
    }
    ...
    public function data()
    {
        ...
        return datatables()
            ...
            ->addColumn('aksi', function ($laporan) {
                ...
                $editUrl = route('laporan_situasi_daerah.edit', ['laporan_situasi_daerah' => $laporan->id_laporan]);
                $showUrl = route('laporan_situasi_daerah.show', ['laporan_situasi_daerah' => $laporan->id_laporan]);
                $deleteUrl = route('laporan_situasi_daerah.destroy', ['laporan_situasi_daerah' => $laporan->id_laporan]);
    ...
    {
        return view('dashboard.laporan_situasi_daerah.create');
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            $validatedData['judul'] = 'Laporan Situasi Daerah';
            ...
            $laporanBaru = LaporanSituasiDaerah::create($validatedData);
            ...
            try {
                ...
                if ($pimpinanUsers->isNotEmpty()) {
                    ...
                    $url = route('laporan_situasi_daerah.show', ['laporan_situasi_daerah' => $laporanBaru->id_laporan, 'from' => 'notification']);
            ...
            return redirect()->route('laporan_situasi_daerah.index')
     ...
     */
    public function show(LaporanSituasiDaerah $laporan_situasi_daerah)
    {
    ...
    {
        $laporan = LaporanSituasiDaerah::findOrFail($id);
        return view('dashboard.laporan_situasi_daerah.edit', compact('laporan'));
    }
    ...
    public function update(Request $request, string $id): RedirectResponse
    {
        ...
        try {
            ...
            if ($originalStatus === LaporanSituasiDaerah::STATUS_REVISION) {
                $updateData['status_laporan'] = LaporanSituasiDaerah::STATUS_PENDING;
                ...
                try {
                    ...
                    if ($pimpinanUsers->isNotEmpty()) {
                        ...
                        $url = route('laporan_situasi_daerah.show', ['laporan_situasi_daerah' => $laporan->id_laporan, 'from' => 'notification']);
